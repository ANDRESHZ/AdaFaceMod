...
def build_model(model_name='ir_50'):
    ...
    elif model_name == 'ir_18_Fine':
        return IR_18(input_size=(112,112))
    elif model_name == 'ir_50_Fine':
        return IR_50(input_size=(112,112))
    elif model_name == 'ir_101_Fine':
        return IR_101(input_size=(112,112))
    elif model_name == 'ir_18_Fine_RIGHT':
        return IR_18(input_size=(112,112))
    elif model_name == 'ir_50_Fine_RIGHT':
        return IR_50(input_size=(112,112))
    elif model_name == 'ir_101_Fine_RIGHT':
        return IR_101(input_size=(112,112))
    elif model_name == 'ir_18_Fine_BGR':
        return IR_18(input_size=(112,112))
    elif model_name == 'ir_50_Fine_BGR':
        return IR_50(input_size=(112,112))
    elif model_name == 'ir_101_Fine_BGR':
        return IR_101(input_size=(112,112))
    else:
    ...
    def __init__(self, input_size, num_layers, mode='ir'):
        ...
        if input_size[0] == 112:
            self.output_layer = Sequential(BatchNorm2d(output_channel),
                                        Dropout(0.4), Flatten(),
                                        Linear(output_channel*7*7 , 512),#Linear(output_channel * 7 * 7, 512),
